...
Repository containing the files and reports I created during my cybersecurity job simulation.

# What I did:
1. Creating an Incident Response Report: I investigated a simulated ransomware attack, analyzed the breach's scope, and documented key findings, including attack vectors, impacted systems, and recommendations to prevent future incidents.
